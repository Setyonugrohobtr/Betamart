...
namespace Betamart
{
    class konfigurasi
    {
        ...
        OleDbConnection con = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\Setyo\Documents\NewBetamart.accdb");
        private OleDbCommand cmd;
        private OleDbDataAdapter da;
        public DataTable dt;
        int result;
        helper funct = new helper();
