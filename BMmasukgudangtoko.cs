...
namespace Betamart
{
    public partial class BMmasukgudangtoko : Form
    {
        public BMmasukgudangtoko()
        {
            InitializeComponent();
        }
        ...
        private void BTNADD_Click(object sender, EventArgs e)
        {
            if(TXTDESC.Text != "" && TXTQTY.Text != "")
            {
                ...
                LBLMSG.Text = "Produk " + TXTPRODUCT.Text + " telah ditambahkan di list produk.";
            ...
            {
                LBLMSG.Text = "Isikan dengan benar pada kolom untuk menyimpan data.";
        ...
        private void LBLTRANSNUM_Click(object sender, EventArgs e)
        {
