...
namespace Betamart
{
    public partial class BMManjemenakun : Form
    {
        public BMManjemenakun()
        {
            InitializeComponent();
        }
        ...
        private void btnnew_Click(object sender, EventArgs e)
        {
            ...
            query = "SELECT USERID , U_NAME AS [Nama pengguna],U_UNAME AS [Nama akun] ,U_TYPE AS [Atribut akun] FROM tblUser WHERE ( U_NAME  + ' ' +  U_UNAME  + ' ' +  U_TYPE) LIKE '%" + txtsearch.Text + "%'";
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            if( txtname.Text != "" && txtusername.Text != "" && txtpass.Text  != "" && cbotype.Text != "" )
            {
                ...
                { 
                    ...
                    config.Execute_CUD(query, "Akun gagal tersimpan.", "Akun baru tersimpan.");
                }
                else
                { 
                    ...
                    config.Execute_CUD(query, "Akun tidak diperbarui (Gagal/dibatalkan).", "Akun berhasil diperbarui.");
                }
                btnnew_Click(sender, e);
            }
            else
        ...
        { 
            ...
            config.Execute_CUD(query, "Akun gagal terhapus.", "Akun terhapus.");
